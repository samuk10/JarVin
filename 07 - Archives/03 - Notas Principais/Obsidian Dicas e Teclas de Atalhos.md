...
| :------------------: | ---------------------------: |
|       Ctrl + T       | Inserir Template `Templater` |
|   Ctrl + Shift + 2   |     Inserir Data do Reminder |
|   Ctrl + Shift + 3   |       Inserir Tarefa `Tasks` |
|   Ctrl + Shift + 4   |       Inserir Tarefa Todoist |
| Ctrl + Shift + Enter |           Alterar Tarefa ✅/❌ |
|       Ctrl + U       |              Alternar Código |
|       CTRL + G       |     Abrir [[Home]] DASHBOARD |
|       CTRL + E       |      Alternar Edit/View Mode |
...
|               Shortcut Key                |                             Functions |
| :---------------------------------------: | ------------------------------------: |
|             Ctrl + Shift + 5              |                    Inserir Code Block |
